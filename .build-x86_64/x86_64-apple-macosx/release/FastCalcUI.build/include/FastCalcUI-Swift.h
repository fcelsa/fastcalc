...
#ifndef FASTCALCUI_SWIFT_H
#define FASTCALCUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FastCalcUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10FastCalcUI21FastCalcAppController")
@interface FastCalcAppController : NSObject <NSApplicationDelegate>
...
@class NSView;
@class NSWindow;
SWIFT_CLASS("_TtC10FastCalcUI20RollWindowController")
@interface RollWindowController : NSWindowController <NSTableViewDataSource, NSTableViewDelegate, NSTextFieldDelegate, NSWindowDelegate>
...
SWIFT_CLASS("_TtC10FastCalcUI24SettingsWindowController")
